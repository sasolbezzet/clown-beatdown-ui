...
import {
  ...
  trim,
  weiUnits
} from "./chunk-M5RF4HKT.js";
import {
  secp256k1
} from "./chunk-IXQJE5ZF.js";
import "./chunk-36AFZC5C.js";
import {
  __export
...
async function recoverPublicKey({ hash: hash2, signature }) {
  ...
  const { secp256k1: secp256k12 } = await import("./secp256k1-7RQKUNCH.js");
  const signature_ = (() => {
...
async function getWebSocketRpcClient(url, options = {}) {
  ...
  return getSocketRpcClient({
    async getSocket({ onClose, onError, onOpen, onResponse }) {
      const WebSocket = await import("./native-AVKHYOAM.js").then((module) => module.WebSocket);
...
async function simulateCalls(client, parameters) {
  ...
  const getBalanceData = account ? encode4(from11("constructor(bytes, bytes)"), {
    ...
    args: [
      getBalanceCode,
      encodeData(from12("function getBalance(address)"), [account.address])
    ]
  }) : void 0;
