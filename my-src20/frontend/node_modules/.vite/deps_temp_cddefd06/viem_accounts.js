...
function privateKeyToAddress(privateKey) {
  const publicKey = bytesToHex2(secp256k1.getPublicKey(privateKey.slice(2), false));
...
export {
  ...
  wordlist8 as simplifiedChinese,
  wordlist9 as spanish,
  toAccount,
  wordlist10 as traditionalChinese
};
